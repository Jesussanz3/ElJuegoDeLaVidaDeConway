...
while True:
    ...
    for i in range(0, filas):
        for j in range(0, columnas):
            ...
            if juegocopia[i, j] == 0:
                pygame.draw.polygon(screen, (128, 0, 0), poly, 0) ##Si la célula está muerta, los bordes del cuadrado de esa célula se mantendrán de color gris oscuro (el cuadrado de la célula se pinta de blanco)
            else:
                pygame.draw.polygon(screen, (0, 0, 128), poly, 0) ##Si la célula está viva, el cuadrado de la célula se pinta de blanco
